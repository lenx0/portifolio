...
>
  <Typography
    sx={{
      ...
      marginTop: "10px",
      "&:hover": {
        textDecoration: "underline", // Adicione os estilos de hover desejados aqui
      },
    }}
  >
    <a
  ...
  ></Box>
            ...
            >
              O projeto exibe uma lista de todos os pokémon existentes, você pode escolher visualiza-los em modo card ou em uma tabela.
              Também temos filtros por tipo e nome, paginação, além de podermos visualizar os bixinhos se movimentando.
              <br />
              <br />
            </Typography>
            <Typography
            ...
            >
              <strong>Front:</strong> NextJS | ReactJS | Javascript | Material-UI<br />
